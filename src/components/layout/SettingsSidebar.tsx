...
export default function SettingsSidebar({ isOpen, onClose }: SettingsSidebarProps) {
  ...
  const [selectedEntityType, setSelectedEntityType] = useState<'contact' | 'deal' | 'company' | 'lead'>('contact');
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center h-16 px-4 border-b border-gray-800">
              <button
                onClick={onClose}
                className="p-2 hover:bg-gray-800 rounded-lg mr-2"
              >
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          className={cn(
                            "flex items-center w-full px-3 py-2 text-sm font-medium rounded-lg transition-colors relative group",
                            isActive 
